...
namespace DotNetCoreWebAPI.HelperMethods
{
    public class RedisConnection
    {
        ...
        private static Lazy<ConfigurationOptions> configOptions = new Lazy<ConfigurationOptions>(() => {
            ...
            config.ClientName = "SafeRedisConnection";
        ...
        //{
        //    get => RedisConnection.lazyConnection.Value;
        //}

        public static ConnectionMultiplexer Connection =>RedisConnection.lazyConnection.Value;
    ...
    public class RedisDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        {
            return RedisConnection.Connection.GetDatabase();
        }
        ...
        public ICollection<TValue> Values
        {
            get
            {
                return new Collection<TValue>(
                    GetRedisDb().HashValues(_redisKey).Select(h => Deserialize<TValue>(h.ToString())).ToList()
                    );
            }
        }
